...
const ClrRadarSolid: React.SFC = () => (
  ...
  >
    <path
      d="M32,18c0,7.7-6.2,14-14,14S4,25.8,4,18c0-7.4,5.7-13.5,13.1-14v3.7c-5.7,0.5-9.8,5.5-9.3,11.2s5.5,9.8,11.2,9.3
		...
		c0,8.8,7.2,16,16,16s16-7.2,16-16c0,0,0,0,0,0H32z"
    />
  </svg>
);
export default ClrRadarSolid;

...
const ClrDataClusterAlerted: React.SFC = () => (
  <svg
    version="1.1"
    viewBox="0 0 36 36"
  ...
  >
    ...
    <path d="M22,4.8c-1.75.63-3,1.68-3,3.12V9.5l.25,0Z" />
    <path d="M33.68,15.4H32v2.84c0,.54-1.46,1.44-3.9,1.73v2c3.13-.32,5.9-1.6,5.9-3.75V15.38Z" />

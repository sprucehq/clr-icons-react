...
const ClrCoinBag: React.SFC = () => (
  ...
  >
    <path d="M21.6,29a1,1,0,0,0-1-1h-6a1,1,0,0,0,0,2h6A1,1,0,0,0,21.6,29Z" />
    <path d="M22.54,24h-6a1,1,0,0,0,0,2h6a1,1,0,0,0,0-2Z" />
    <path d="M22,32H16a1,1,0,0,0,0,2h6a1,1,0,0,0,0-2Z" />
    <path d="M32.7,32h-7a1,1,0,0,0,0,2h7a1,1,0,0,0,0-2Z" />
    <path d="M33.7,28h-7a1,1,0,0,0,0,2h7a1,1,0,0,0,0-2Z" />

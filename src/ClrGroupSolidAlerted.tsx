...
const ClrGroupSolidAlerted: React.SFC = () => (
  <svg
    version="1.1"
    viewBox="0 0 36 36"
  ...
  >
    ...
    <path d="M17.87,17.92a4.46,4.46,0,0,0,4-2.54A3.67,3.67,0,0,1,19,9.89l.35-.61A4.42,4.42,0,0,0,17.87,9a4.47,4.47,0,1,0,0,8.93Z" />

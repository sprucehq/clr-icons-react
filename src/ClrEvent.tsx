...
const ClrEvent: React.SFC = () => (
  ...
  >
    <path d="M16.17,25.86,10.81,20.5a1,1,0,0,1,1.41-1.41L16.17,23l8.64-8.64a1,1,0,0,1,1.41,1.41Z" />
    ...
    <rect x="13" y="6" width="10" height="2" />
  </svg>
);
export default ClrEvent;

...
const ClrComputerAlerted: React.SFC = () => (
  <svg
    version="1.1"
    viewBox="0 0 36 36"
  ...
  >
    ...
    <path d="M9.6,22.88V10.6h9.14A3.64,3.64,0,0,1,19,9.89L19.56,9H8V22.88Z" />
    <path d="M6,7H20.71l1.15-2H5.5A1.5,1.5,0,0,0,4,6.5V23H6Z" />
    <rect x="30" y="15.4" width="2" height="7.6" />

...
const ClrCoinBagSolid: React.SFC = () => (
  <svg
    version="1.1"
    viewBox="0 0 36 36"
  ...
  >
    ...
    <path d="M22.54,23.5h-6a1,1,0,0,0,0,2h6a1,1,0,0,0,0-2Z" />
    <path d="M22,31.5H16a1,1,0,0,0,0,2h6a1,1,0,0,0,0-2Z" />
    <path d="M32.7,31.5h-7a1,1,0,0,0,0,2h7a1,1,0,0,0,0-2Z" />
    <path d="M33.7,27.5h-7a1,1,0,0,0,0,2h7a1,1,0,0,0,0-2Z" />
  </svg>
);
